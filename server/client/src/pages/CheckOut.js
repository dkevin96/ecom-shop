    ...
    <LayoutHelmet loading={fetchStatus !== "succeeded"}>
      <div className="flex flex-col justify-center items-center">
        <div className="w-full md:w-1/2">
          ...
          <h2 className="font-medium text-xl text-center mb-6">
            Enter credit card information
          </h2>
          <p className="text-lg text-gray-500">
            You can use credit card nr 4242424242424242 with any future date,
            CVC and zip-code for testing. This transaction is just a test and
            will not charge any real money.
          </p>
