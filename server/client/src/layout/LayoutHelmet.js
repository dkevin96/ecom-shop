  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:description" content="Store built with React, Redux, Node, Express and Postgres" />
        ...
        <meta name="twitter:description" content="Store built with React, Redux, Node, Express and Postgres" />
